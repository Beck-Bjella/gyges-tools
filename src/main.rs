...
fn main() {
    ...
    // Data conversion
    // convert_dataset("training_data/raw_positions.csv", "training_data/converted_positions.csv");
    ...
    let hce_baseline = EngineConfig {
        ...
        path: String::from("./engines/UPDATED BASELINE"),
    };
